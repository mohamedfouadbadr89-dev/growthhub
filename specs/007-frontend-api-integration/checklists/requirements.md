...
- Edge cases cover token expiry, empty states, non-JSON error bodies, network timeout, and LTD plan BYOK gate
- Campaigns pages explicitly excluded from scope (already connected in Phase 6)
