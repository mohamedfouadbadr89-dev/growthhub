...
-- Decisions updates
ALTER TABLE decisions ADD COLUMN IF NOT EXISTS reasoning_steps JSONB;
ALTER TABLE decisions ADD COLUMN IF NOT EXISTS suggested_action_id UUID;
ALTER TABLE decisions ADD COLUMN IF NOT EXISTS metadata JSONB;
ALTER TABLE decisions ADD COLUMN IF NOT EXISTS confidence_score NUMERIC(5,2);

ALTER TABLE decisions DROP CONSTRAINT IF EXISTS decisions_status_check;

ALTER TABLE decisions ADD CONSTRAINT decisions_status_check CHECK (
